...
const cases = [
  {
    ...
    english:
      'Increase quota for user “quota-owner” (ID: 42) · Requested quota: 坤币 1 · 坤币 1 → 坤币 2',
    chinese: '增加用户「quota-owner」的额度（ID: 42） · 请求数额：坤币 1 · 坤币 1 → 坤币 2',
  },
  {
    action: 'user.quota_add',
    params: { quota: 500000 },
    english:
      'Increase user quota · Target not recorded · Requested quota: 坤币 1 · Not recorded → Not recorded',
    chinese: '增加用户额度 · 目标未记录 · 请求数额：坤币 1 · 未记录 → 未记录',
  },
  {
    action: 'user.quota_subtract',
    params: { quota: 500000 },
    english:
      'Decrease user quota · Target not recorded · Requested quota: 坤币 1 · Not recorded → Not recorded',
    chinese: '减少用户额度 · 目标未记录 · 请求数额：坤币 1 · 未记录 → 未记录',
  },
  {
    action: 'user.quota_override',
    params: { from: 500000, to: 0 },
    english:
      'Override user quota · Target not recorded · Requested quota: 坤币 0 · 坤币 1 → 坤币 0',
    chinese: '覆盖用户额度 · 目标未记录 · 请求数额：坤币 0 · 坤币 1 → 坤币 0',
  },
]
