...
export function IntelligenceTest() {
  ...
  return (
    // The scroll container spans the full content pane so the scrollbar stays
    // at the window edge and the wheel works over the side whitespace; the
    // centered max-width wrapper only lays out the content inside it.
